...
export const Sidebar = ({ className, isMobileOpen = false, onMobileClose }: SidebarProps) => {
  ...
  return (
    <>
      ...
      <div className={cn(
        "w-64 h-screen bg-sidebar-bg border-r border-border sidebar-shadow fixed left-0 top-0 z-50 flex flex-col transform transition-transform duration-300 ease-in-out",
        !isMobileOpen && "-translate-x-full lg:translate-x-0",
        isMobileOpen && "translate-x-0",
        className
      )}>
